...
CONFIG = {
    "parallelstore": {
        ...
        "instance_id": "pvc-d13842ae-2bd4-4602-bd11-002eb1197011", # VERIFY THIS!
...
def log_daily_performance_over_period(start_date_overall: datetime, end_date_overall: datetime):
    ...
    over a specified period. Skips detailed printing if no metrics are found for a day.
    """
    ...
    while current_day_iterator <= end_date_overall:
        ...
        daily_throughput_bytes_sec = None # Intermediate variable
        ...
        try:
            ...
            # Conditional printing: Only print details if at least one metric was found
            ...
            # In case of error, metrics will likely be None, leading to "No significant..." or specific "No data" messages.
    ...
    # Uncomment to save the summary to a JSON file:
    # import json
...
if __name__ == "__main__":
    ...
    period_start_date = datetime(2025, 3, 1, 0, 0, 0, tzinfo=timezone.utc) # March 1st, 2025
    
    # Current date is May 9, 2025. We want to include this day.
    # The loop `while current_day_iterator <= end_date_overall:` handles inclusivity.
    period_end_date = datetime(2025, 5, 9, 0, 0, 0, tzinfo=timezone.utc) # May 9th, 2025
